...
class opts(object):
    def __init__(self):
        ...
        # ! add svo argument for zed
        self.parser.add_argument('--svo', help='svo file path')
        ...
        self.parser.add_argument('--load_model', default='../models/fairmot_lite.pth',
                                 help='path to pretrained model')
    ...
    def init(self, args=''):
        ...
        # }
        default_dataset_info = {
            'mot': {'default_resolution': [320, 576], 'num_classes': 1,
                    'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                    'dataset': 'jde', 'nID': 14455},
        }
