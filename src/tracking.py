...
# /home/gabor/Documents/FairMOT/videos
...
for seq_name in opts.seq_names:
    ...
    # Init tracker
    tracker = Tracker(det_path, gt_path, opts.max_age, opts.max_dist_iou, opts.max_dist_feature, opts.n_init, opts.reinit_interval, opts.metric, opts.detect_method, opts.point_termi, opts.start_ind,
